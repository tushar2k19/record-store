...
export default {
  ...
  methods: {
    ...
    addArtist () {
      ...
      this.$http.secured.post('/artists', { artist: { name: this.newArtist.name } })
    ...
    removeArtist (artist) {
      this.$http.secured.delete(`/artists/${artist.id}`)
        .then(response => {
    ...
    editArtist (artist) {
      ...
      console.log("editedArtist = ", this.editedArtist)
      console.log("artists = ", this.artists)

    },
    updateArtist (artist) {
      console.log("inside artists, updateArtist()")
      this.editedArtist = ''
      this.$http.secured.patch(`/artists/${artist.id}`, { artist: { name: artist.name } })
